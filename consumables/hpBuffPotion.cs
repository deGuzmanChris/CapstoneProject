...
public class healingPotion : items
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.B))
        {
            ...
            //Adds buff amount to current HP
            int buffedHP = currentHP + buffAmount;
            float spellStart = Time.time;

            //Sets player HP to new buffed amount
